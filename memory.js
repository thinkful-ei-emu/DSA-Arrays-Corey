class Memory {
  constructor() {
    this.memory = new Float64Array(2048);
    this.head = 0;
  }

  //Reserves a contiguous block of memory consisting of 
  //size boxes which you can safely modify, returning a 
  //pointer to the first box, or null if the allocation fails.
  allocate(size) {
  ...
  //For example, copy(10, 0, 3) would copy the values at 
